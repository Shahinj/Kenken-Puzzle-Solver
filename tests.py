...
class TestStringMethods(unittest.TestCase):
    def helper_prop(self, board, prop=prop_GAC, var_ord=ord_mrv, val_ord = val_lcv):
...
if __name__ == '__main__':
    ...
    # board = [[5],[11,21,22,10,0],[12,13,7,0],[14,15,2,1],[24,25,2,1],[23,33,43,12,0],[31,32,6,0],[41,42,2,1],[51,3],[52,53,1,1],[54,55,1,1],[34,44,1,1],[35,45,4,1]]
    
    # board = [[4],[11,4],[21,31,4,0],[41,42,1,1],[12,22,2,2],[32,4],[13,14,24,24,3],[23,33,2,2],[43,44,34,8,0]]
    ...
    # board = [[3],[11,21,12,7,0],[13,2],[31,2],[22,23,3,0],[32,33,2,1]]
    
    # board = [[4],[11,21,12,3],[12,3],[22,23,1,1],[13,14,24,7,0],[31,32,2,2],[41,42,3,1],[33,34,12,3],[43,44,1,1]]
    # 
    # board = [[6],[11,12,21,24,3],[13,14,1,1],[15,16,3,1],[22,31,32,33,17,0],[23,24,1,1],[25,35,2,2],[26,36,2,2],[34,44,3,1],[41,42,3,2],[43,53,7,0],[45,46,2,1],[51,52,3,1],[54,55,10,3],[56,6],[61,62,2,1],[63,64,3,2],[65,66,20,3]]
    # 
    # csp, var_array = kenken_csp_model(board)
    # solver = BT(csp)
    # solver.trace_off()
    # k = solver.bt_search(prop_GAC, ord_mrv)
    # self.assertTrue(check_cages(var_array, board), "Incorect value in a cage!")
    # self.assertTrue(check_diff(var_array, board), "Repeated value in a row or column!")